...
1. **Edit the schema** — Modify `prisma/schema.prisma` with the requested change (new field, new model, enum value, etc.).
...
Reference `CLAUDE.md` for Prisma 7 conventions (PrismaPg adapter, `defineConfig`).
